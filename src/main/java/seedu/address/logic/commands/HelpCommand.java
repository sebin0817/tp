...
public class HelpCommand extends Command {
    ...
    static {
        ...
        commandUsageMap.put(AddNoteCommand.COMMAND_WORD, AddNoteCommand.MESSAGE_USAGE);
        commandUsageMap.put(DeleteNoteCommand.COMMAND_WORD, DeleteNoteCommand.MESSAGE_USAGE);
        commandUsageMap.put(EditNoteCommand.COMMAND_WORD, EditNoteCommand.MESSAGE_USAGE);
        commandUsageMap.put(ListNoteCommand.COMMAND_WORD, ListNoteCommand.MESSAGE_USAGE);
        commandUsageMap.put(ArchiveCommand.COMMAND_WORD, ArchiveCommand.MESSAGE_USAGE);
        commandUsageMap.put(COMMAND_WORD, MESSAGE_USAGE);
        commandUsageMap.put(ExitCommand.COMMAND_WORD, ExitCommand.MESSAGE_USAGE);
        commandUsageMap.put(UndoCommand.COMMAND_WORD, UndoCommand.MESSAGE_USAGE);
    }
